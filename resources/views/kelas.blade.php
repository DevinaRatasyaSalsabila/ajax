...
<body>
        ...
        <div class="card outline-success animate__animated animate__zoomInRight">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped" id="data-kelas">
                        <thead>
                            <tr>
                            ...
                            {{-- <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn-warning btn-sm btn m-1"
                                        data-bs-toggle="modal" data-bs-target="#edit_kelas"
                                        data-bs-kelas="Bahasa Inggris"
                                        data-bs-jurusan="Normatif">
                                        Edit
                                    </button>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="kelas-tambah" onkeyup="tambah_kelas()"
                                    placeholder="Masukkan Nama Kelas">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="" class="form-label col-sm-2">Jurusan</label>
                            <div class="col-sm-10">
    ...
    <!-- Modal Edit Siswa -->
    <div class="modal fade" id="edit_kelas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="mb-3 row">
                            <label for="nama_kelas" class="form-label col-sm-2">Nama Kelas</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control nama_kelas" id="kelas" name="kelas"
                                    placeholder="Masukkan Nama kelas" value="Bahasa Indonesia">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="" class="form-label col-sm-2">Jurusan</label>
                            <div class="col-sm-10">
                                <select class="form-select selectJurusan" id="selectJurusan" name="selectJurusan "
    ...
    <script>
        const exampleModal = document.getElementById('edit_kelas')
        if (exampleModal) {
            exampleModal.addEventListener('show.bs.modal', event => {
                ...
                const nama_kelas = button.getAttribute('data-bs-kelas')
                const kategori = button.getAttribute('data-bs-jurusan')

                const modalTitle = exampleModal.querySelector('.modal-title')
                const input_nama = exampleModal.querySelector('.modal-body input#kelas')
                const input_kategori = exampleModal.querySelector(
                    '.modal-body select.selectKategori')

                modalTitle.textContent = `Data ${nama_kelas}`

                input_nama.value = nama_kelas
        ...
        function tambahSiswa() {
            ...
            const nama = document.getElementById('kelas-tambah').value;
            console.log(nama);
        }

        function tambah_kelas() {
            nama = $('#kelas-tambah').val();
            console.log(nama);
        }
